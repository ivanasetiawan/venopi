...
const components = {};
function components_9c6bc2f8(nuxtApp) {
...
const vueuseHead_34942873 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_16d1b332 = defineNuxtPlugin((nuxtApp) => {
...
const router_183fbfda = defineNuxtPlugin((nuxtApp) => {
  const routes = [];
  const hooks = {
    "navigate:before": [],
    "resolve:before": [],
